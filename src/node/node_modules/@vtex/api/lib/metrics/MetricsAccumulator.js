...
exports.MetricsAccumulator = void 0;
...
class MetricsAccumulator {
    constructor() {
        ...
        this.batch = (name, diffNs, extensions) => {
            this.batchMetric(name, diffNs ? (0, time_1.hrToMillis)(diffNs) : undefined, extensions);
        };
        ...
        this.metricToAggregate = (value, key) => {
            const aggregate = {
                ...
                count: value.length,
                max: Math.max(...value),
                mean: (0, stats_lite_1.mean)(value),
                median: (0, stats_lite_1.median)(value),
                percentile95: (0, stats_lite_1.percentile)(value, 0.95),
                percentile99: (0, stats_lite_1.percentile)(value, 0.99),
                production,
                ...this.extensions[key],
            };
        ...
        this.flushMetrics = () => {
            const aggregateMetrics = (0, ramda_1.values)((0, ramda_1.mapObjIndexed)(this.metricToAggregate, this.metricsMillis));
            const systemMetrics = [
                {
                    ...cpuUsage(),
                    name: 'cpu',
            ...
            const onFlushMetrics = (0, ramda_1.flatten)((0, ramda_1.map)(getMetric => getMetric(), this.onFlushMetrics));
            const envFlushMetric = (0, ramda_1.map)((0, ramda_1.assoc)('production', production), onFlushMetrics);
            const cacheMetrics = (0, ramda_1.values)((0, ramda_1.mapObjIndexed)(this.cacheToMetric, this.cacheMap));
