...
exports.cleanError = exports.SENSITIVE_EXCEPTION_FIELDS = exports.PICKED_AXIOS_PROPS = void 0;
...
const findCaseInsensitive = (target, set) => (0, ramda_1.find)(t => t.toLocaleLowerCase() === target, set);
const destroyCircular = (from, seen) => {
    ...
    for (const property of axiosProperties) {
        if (to[property] != null && typeof to[property] === 'object') {
            to[property] = (0, ramda_1.pick)(exports.PICKED_AXIOS_PROPS, to[property]);
            const headers = to[property] && to[property].headers;
            if (headers) {
                const headerNames = (0, ramda_1.keys)(headers);
