...
class MetricsLogger {
    constructor() {
        ...
        //////////////////////
        let samples = {};
        let lastCpu = (0, diff_1.cpuSnapshot)();
        //////////////////////
        // private methods definitions
        //////////////////////
        const summaries = (0, ramda_1.compose)((0, ramda_1.reject)(ramda_1.isNil), ramda_1.values, (0, ramda_1.mapObjIndexed)(getSummary));
        ...
        function getCpuUsage() {
            const cpu = (0, diff_1.cpuSnapshot)();
            const cpuDiff = (0, diff_1.snapshotDiff)(cpu, lastCpu);
            lastCpu = cpu;
            const metric = {
                Data: {
                    key: {
        ...
        function validKey(key) {
            ...
            try {
                (0, fast_json_stable_stringify_1.default)(key);
            }
            catch {
                return false;
            }
        ...
        function getNumericSummary(vals) {
            return {
                count: vals.length,
                max: Math.max(...vals),
                median: (0, stats_lite_1.median)(vals),
                min: Math.min(...vals),
                percentile95: (0, stats_lite_1.percentile)(vals, 0.95),
                percentile99: (0, stats_lite_1.percentile)(vals, 0.99),
                sum: (0, stats_lite_1.sum)(vals),
            };
        }
        //////////////////////
