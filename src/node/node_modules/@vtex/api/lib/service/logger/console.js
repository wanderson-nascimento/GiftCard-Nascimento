...
exports.logOnceToDevConsole = exports.log = exports.isLog = exports.LOG_ONCE = void 0;
...
const isLog = (message) => (message === null || message === void 0 ? void 0 : message.cmd) === exports.LOG_ONCE;
exports.isLog = isLog;
...
exports.logOnceToDevConsole = logOnceToDevConsole;
