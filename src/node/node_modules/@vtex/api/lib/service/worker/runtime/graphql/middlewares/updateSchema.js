...
const updateSchema = (graphql, executableSchema) => async function updateRunnableSchema(ctx, next) {
    ...
    if (executableSchema.hasProvider &&
        (!executableSchema.provider ||
            (0, utils_1.majorEqualAndGreaterThan)((0, utils_1.parseAppId)(ctx.headers[constants_1.PROVIDER_HEADER]).version, (0, utils_1.parseAppId)(executableSchema.provider).version))) {
        try {
