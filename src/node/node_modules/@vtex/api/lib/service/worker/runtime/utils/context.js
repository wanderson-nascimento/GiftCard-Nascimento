...
exports.prepareHandlerCtx = void 0;
...
const prepareHandlerCtx = (header, tracingContext) => {
    var _a;
    const partialContext = {
        account: header[constants_1.ACCOUNT_HEADER],
        authToken: header[constants_1.CREDENTIAL_HEADER],
        binding: header[constants_1.BINDING_HEADER] ? (0, binding_1.parseBindingHeaderValue)(header[constants_1.BINDING_HEADER]) : undefined,
        host: header[constants_1.FORWARDED_HOST_HEADER],
        locale: header[constants_1.LOCALE_HEADER],
        operationId: header[constants_1.OPERATION_ID_HEADER] || (0, v4_1.default)(),
        ...
        tenant: header[constants_1.TENANT_HEADER] ? (0, tenant_1.parseTenantHeaderValue)(header[constants_1.TENANT_HEADER]) : undefined,
        tracer: new UserLandTracer_1.UserLandTracer(tracingContext === null || tracingContext === void 0 ? void 0 : tracingContext.tracer, tracingContext === null || tracingContext === void 0 ? void 0 : tracingContext.currentSpan),
...
exports.prepareHandlerCtx = prepareHandlerCtx;
