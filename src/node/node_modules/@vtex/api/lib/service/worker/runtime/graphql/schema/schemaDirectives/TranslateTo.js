...
exports.translateToDirectiveTypeDefs = exports.TranslateTo = void 0;
    ...
    visitFieldDefinition(field) {
        ...
        field.resolve = async (root, args, ctx, info) => {
            ...
            if (!((_a = ctx.loaders) === null || _a === void 0 ? void 0 : _a.immutableMessagesV2)) {
                ...
                ctx.loaders = {
                    ...ctx.loaders,
                    immutableMessagesV2: (0, messagesLoaderV2_1.createMessagesLoader)(ctx.clients, language, dependencies),
                };
            }
            const response = (await resolve(root, args, ctx, info));
            const { vtex, loaders: { immutableMessagesV2 }, } = ctx;
            const handler = (0, translations_1.handleSingleString)(vtex, immutableMessagesV2, behavior, 'translateTo');
