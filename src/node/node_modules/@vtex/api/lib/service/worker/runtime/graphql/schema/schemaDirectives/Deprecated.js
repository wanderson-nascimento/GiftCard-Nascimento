...
exports.deprecatedDirectiveTypeDefs = exports.Deprecated = void 0;
    ...
    visitFieldDefinition(field) {
        ...
        field.resolve = (root, args, ctx, info) => {
            ...
            this.maybeLogToSplunk({
                ...
                name,
                query: ((_a = ctx.graphql.query) === null || _a === void 0 ? void 0 : _a.document) && (0, graphql_1.print)((_b = ctx.graphql.query) === null || _b === void 0 ? void 0 : _b.document),
                reason,
