...
exports.prometheusLoggerMiddleware = exports.addMetricsLoggerMiddleware = exports.recorderMiddleware = void 0;
...
const addMetricsLoggerMiddleware = () => {
...
exports.addMetricsLoggerMiddleware = addMetricsLoggerMiddleware;
const prometheusLoggerMiddleware = () => {
    ...
    return async (ctx, next) => {
        ...
        ctx.body = await prom_client_1.register.metrics();
        ctx.status = 200;
    };
};
exports.prometheusLoggerMiddleware = prometheusLoggerMiddleware;
