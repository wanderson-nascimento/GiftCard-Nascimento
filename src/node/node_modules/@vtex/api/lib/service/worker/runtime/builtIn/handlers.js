...
exports.metricsLoggerHandler = exports.healthcheckHandler = exports.whoAmIHandler = void 0;
const whoAmIHandler = ({ events, routes, }) => (ctx) => {
    var _a, _b;
...
const healthcheckHandler = ({ events, routes, }) => (ctx) => {
    var _a, _b;
...
const metricsLoggerHandler = (ctx) => {
    var _a, _b;
...
exports.metricsLoggerHandler = metricsLoggerHandler;
