...
const APP_ELAPSED_TIME_LOCATOR = (0, time_1.shrinkTimings)((0, time_1.formatTimingName)({
    hopNumber: 0,
...
async function timings(ctx, next) {
    ...
    const totalMillis = (0, time_1.hrToMillis)(total);
    console.log(log(ctx, totalMillis));
    console.log(logBillingInfo(vtex, totalMillis));
    const status = (0, status_1.statusLabel)(statusCode);
