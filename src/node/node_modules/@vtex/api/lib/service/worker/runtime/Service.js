...
class Service {
    constructor(config) {
        ...
        if (config.routes && config.routes.graphql) {
            (0, logger_1.logOnceToDevConsole)(`Route id "graphql" is reserved and apps containing this routes will stop working in the near future. To create a GraphQL app, export a "graphql" key with {resolvers}.`, logger_1.LogLevel.Warn);
        }
    }
}
