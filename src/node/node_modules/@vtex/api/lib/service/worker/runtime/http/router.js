...
exports.routerFromPublicHttpHandlers = void 0;
const constants_1 = require("../../../../constants");
const logger_1 = require("../../../logger");
const console_1 = require("./../../../logger/console");
const routerFromPublicHttpHandlers = (routes) => {
    return async (ctx, next) => {
        ...
        if (!handler) {
            ...
            ctx.status = 501;
            ctx.body = msg;
            (0, console_1.logOnceToDevConsole)(msg, logger_1.LogLevel.Error);
            return;
        }
        await handler(ctx, next);
    };
};
exports.routerFromPublicHttpHandlers = routerFromPublicHttpHandlers;
