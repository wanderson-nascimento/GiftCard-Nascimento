...
const rateLimit_1 = require("../http/middlewares/rateLimit");
...
const createEventHandler = (clientsConfig, eventId, handler, serviceEvent, globalLimiter) => {
    var _a, _b;
    const { implementation, options } = clientsConfig;
    const middlewares = (0, toArray_1.toArray)(handler);
    const pipeline = [
        (0, tracingMiddlewares_1.nameSpanOperationMiddleware)('event-handler', eventId),
        context_1.eventContextMiddleware,
        body_1.parseBodyMiddleware,
        (0, clients_1.clients)(implementation, options),
        ...((serviceEvent === null || serviceEvent === void 0 ? void 0 : serviceEvent.settingsType) === 'workspace' || (serviceEvent === null || serviceEvent === void 0 ? void 0 : serviceEvent.settingsType) === 'userAndWorkspace' ? [(0, settings_1.getServiceSettings)()] : []),
        timings_1.timings,
        (0, rateLimit_1.concurrentRateLimiter)((_a = serviceEvent === null || serviceEvent === void 0 ? void 0 : serviceEvent.rateLimitPerReplica) === null || _a === void 0 ? void 0 : _a.concurrent),
        (0, rateLimit_1.perMinuteRateLimiter)((_b = serviceEvent === null || serviceEvent === void 0 ? void 0 : serviceEvent.rateLimitPerReplica) === null || _b === void 0 ? void 0 : _b.perMinute, globalLimiter),
...
function contextAdapter(middlewares) {
    return async function middlewareCascade(ctx) {
        ...
        await (0, compose_1.composeForEvents)(middlewares)(ctxEvent);
        ctx.status = 204;
    };
}
