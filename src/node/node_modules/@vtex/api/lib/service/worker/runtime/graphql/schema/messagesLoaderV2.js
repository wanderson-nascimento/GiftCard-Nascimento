...
exports.createMessagesLoader = void 0;
const dataloader_1 = __importDefault(require("dataloader"));
const ramda_1 = require("ramda");
const sortByContentAndFrom = (indexedMessages) => (0, ramda_1.sortBy)(([_, { content, from }]) => `__from:${from}__content:${content}`, indexedMessages);
...
const createMessagesLoader = ({ messagesGraphQL, assets }, to, dependencies) => {
    ...
    return new dataloader_1.default(async (messages) => {
        ...
        const indexedTranslations = (0, ramda_1.zip)(originalIndexes, translations);
...
exports.createMessagesLoader = createMessagesLoader;
