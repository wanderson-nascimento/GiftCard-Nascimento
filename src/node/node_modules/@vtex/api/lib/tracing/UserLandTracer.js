...
exports.UserLandTracer = exports.createTracingContextFromCarrier = void 0;
const opentracing_1 = require("opentracing");
const TracerSingleton_1 = require("../service/tracing/TracerSingleton");
const utils_1 = require("./utils");
const createTracingContextFromCarrier = (newSpanName, carrier) => {
...
exports.createTracingContextFromCarrier = createTracingContextFromCarrier;
class UserLandTracer {
    constructor(tracer, fallbackSpan) {
        this.tracer = tracer;
        this.fallbackSpan = fallbackSpan;
        this.fallbackSpanLock = false;
        const { traceId, isSampled } = (0, utils_1.getTraceInfo)(fallbackSpan);
    ...
    fallbackSpanContext() {
        var _a;
        return (_a = this.fallbackSpan) === null || _a === void 0 ? void 0 : _a.context();
    }
}
