...
class Segment extends JanusClient_1.JanusClient {
    constructor() {
         ...
         * @memberof Segment
         */
        this.getSegment = (tracingConfig) => this.rawSegment(this.context.segmentToken, undefined, tracingConfig).then((0, ramda_1.prop)('data'));
        /**
         * Get the segment data from this specific segment token
         *
         * @memberof Segment
         */
        this.getSegmentByToken = (token, tracingConfig) => this.rawSegment(token, undefined, tracingConfig).then((0, ramda_1.prop)('data'));
