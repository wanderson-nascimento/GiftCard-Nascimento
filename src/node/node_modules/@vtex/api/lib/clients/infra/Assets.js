...
const useBuildJson = (app, appVendorName) => {
    ...
    return buildFeatures && buildFeatures[appVendorName] && (0, ramda_1.contains)('build.json', buildFeatures[appVendorName]);
};
...
class Assets extends InfraClient_1.InfraClient {
    ...
    async getBuildJSONForApp(app, appVendorName, pick = [], tracingConfig) {
        ...
        const result = !(0, ramda_1.isEmpty)(pickArray) ? (0, ramda_1.pick)(pickArray, buildJson) : buildJson;
    ...
    async getSettingsFromFilesForApp(app, files = [], tracingConfig) {
        ...
        const result = (0, ramda_1.zipObj)(filesArray, fetched);
        result.declarer = app.id;
        return result;
    }
    async getJSON(appId, file, nullIfNotFound, tracingConfig) {
        const locator = (0, utils_1.parseAppId)(appId);
    ...
    getFilteredDependencies(apps, dependencies) {
        ...
        return (0, ramda_1.filter)(depends, dependencies);
    }
}
