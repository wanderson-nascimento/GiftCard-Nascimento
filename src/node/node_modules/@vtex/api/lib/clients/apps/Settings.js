...
const containsLinks = (0, ramda_1.any)(app_1.isLinkedApp);
class Settings extends AppClient_1.AppClient {
    ...
    getFilteredDependencies(appAtMajor, dependencies) {
        return (0, settings_1.getFilteredDependencies)(appAtMajor, dependencies);
    }
    getDependenciesHash(dependencies) {
        return (0, settings_1.getDependenciesHash)(dependencies);
    }
