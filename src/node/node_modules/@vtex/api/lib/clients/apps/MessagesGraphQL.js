...
exports.MessagesGraphQL = void 0;
...
class MessagesGraphQL extends AppGraphQLClient_1.AppGraphQLClient {
    ...
    translateV2(args, tracingConfig) {
        ...
        const batchedMessages = (0, ramda_1.splitEvery)(MAX_BATCH_SIZE, allMessages);
        ...
        return Promise.all(batchedMessages.map(batch => {
            ...
            const batchArgs = {
                ...rest,
                indexedByFrom: (0, ramda_1.values)(indexedBatch),
            };
      ...
      `,
            ...
            }).then((0, ramda_1.path)(['data', 'translate']));
